...
export default function Signup() {
  ...
  return <form onSubmit={onSubmit}
    ...
    <label>
      Name
      <input type="text" name="name" className="border block w-full outline-transparent p-2 rounded" />
    </label>

    <label>
      Email
      <input type="email" name="email" className="border block w-full outline-transparent p-2 rounded" />
    </label>

    <label>
      Password
      <input type="password" name="password" className="border block w-full outline-transparent p-2 rounded" />
    </label>
